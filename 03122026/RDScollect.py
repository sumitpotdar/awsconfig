    ...
    Returns a dict:
        {
            ...
            'env':       str | None,    # env parsed from prefix pattern
        }
    """
    result = {'matched': False, 'match_type': None, 'app_name': None, 'env': None, 'unique_id': None}
            ...
            for stub in page.get('SecretList', []):
                ...
                if not match['matched'] and instance_id in description:
                    match = {'matched': True, 'match_type': 'description',
                             'app_name': None, 'env': None, 'unique_id': None}
                ...
                print(f"  Matched secret [{match['match_type']}]: {secret_name}"
                      + (f"  (app={match['app_name']}, env={match['env']})"
